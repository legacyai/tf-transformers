...
def run_train(cfg):
    ...
    # Get Model
    model_fn = get_model(return_all_layer_outputs, is_training, use_dropout)

    # Get Optimizer
    examples = epochs * steps_per_epoch  # Assume steps_per_epoch = 100000, and epochs = 5, examples = 500000
    optimizer_fn = get_optimizer(learning_rate, examples, train_batch_size, epochs)
    ...
    # get original directory from hydra
    original_cwd = get_original_cwd()
    model_checkpoint_dir = os.path.join(original_cwd, model_checkpoint_dir)
