...
One can use :class:`~tf_transformers.models.T5Model` for fine-tuning tasks.
Pretraining is **TODO**.
...
`Paper👆 <https://arxiv.org/abs/1910.10683>`__
`Official Code👆 <https://github.com/google-research/text-to-text-transfer-transformer>`__
