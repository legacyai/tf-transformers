...
@add_start_docstrings(
    "T5 Model :",
    ENCODER_CLASS_DOCSTRING.format("tf_transformers.models.t5.T5Config"),
)
class T5Encoder(LegacyLayer):
    ...
    @add_start_docstrings(
        "T5 Encoder Text Generation :",
        "T5 encoder standalone text generation is not yet implemnted due to relative postional embedding",
    )
    ...
    @add_start_docstrings(
        "Forward pass of T5 Decoder Auto Regressive/ Text Generation :",
        CALL_DECODER_AUTO_REGRESSIVE_DOCSTRING,
    )
