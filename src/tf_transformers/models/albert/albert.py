...
class AlbertEncoder(LegacyLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._intermediate_embedding_projection = dense_einsum.DenseEinsum(
            output_shape=config["embedding_projection_size"],
            activation=None,
        ...
        layer = TransformerBERT(
            hidden_size=config["embedding_projection_size"],
        ...
        self._pooler_layer = tf.keras.layers.Dense(
            units=config["embedding_projection_size"],
            activation="tanh",
            kernel_initializer=self._initializer,
    ...
    def call_encoder(self, inputs):
        ...
        # 2. Norm + Intermediate Projection + dropout
