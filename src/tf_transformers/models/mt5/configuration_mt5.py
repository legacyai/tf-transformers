...
class MT5Config(TransformerConfig):
    ...
    It is used to instantiate an MT5 model according to the specified arguments, defining the model architecture.
    Instantiating a configuration with the defaults will yield a similar configuration to that of the
    MT5 `base <https://huggingface.co/t5-small>`__ architecture.
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30000):
            ...
            :obj:`inputs_ids` passed when calling :class:`~tf_transformers.model.MT5Model` or
            :class:`~tf_transformers.models.MT5Encoder`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~transformers.MT5Model` or
