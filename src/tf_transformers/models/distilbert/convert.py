...
def convert_bert_pt(model, config, model_name):
    """PT converter
    Args:
    ...
    model_hf = DistilBertModel.from_pretrained(model_name)
    ...
    model_hf = DistilBertForMaskedLM.from_pretrained(model_name)
    hf_vars = [
