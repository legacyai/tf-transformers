...
@add_start_docstrings(
    "Clip Text Model :",
    ENCODER_CLASS_DOCSTRING.format("tf_transformers.models.clip.CLIPTextConfig"),
)
class CLIPTextEncoder(LegacyLayer):
    def __init__(
        self,
        config: Dict,
    ...
    @add_start_docstrings(
        "Forward pass of CLIP text Auto Regressive/ Text Generation :",
        CALL_ENCODER_AUTO_REGRESSIVE_DOCSTRING,
    )
    ...
    @add_start_docstrings(
        "Forward pass of CLIP Text Decoder :",
        CALL_DECODER_DOCSTRING,
    )
    ...
    @add_start_docstrings(
        "Forward pass of CLIP Text Decoder Auto Regressive/ Text Generation :",
        CALL_DECODER_AUTO_REGRESSIVE_DOCSTRING,
    )
