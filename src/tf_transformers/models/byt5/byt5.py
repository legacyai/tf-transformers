...
from tf_transformers.layers.transformer import TransformerByT5
...
ByT5_DECODER_START_TOKEN_ID = 0


@add_start_docstrings(
    "ByT5 Model :",
    ENCODER_CLASS_DOCSTRING.format("tf_transformers.models.byt5.ByT5Config"),
)
class ByT5Encoder(LegacyLayer):
    def __init__(
        self,
        config,
        ...
        **kwargs,
        ...
        super(ByT5Encoder, self).__init__(
    ...
    @add_start_docstrings(
        "ByT5 Encoder Text Generation :",
        "ByT5 encoder standalone text generation is not yet implemnted due to relative postional embedding",
    )
    ...
    @add_start_docstrings(
        "Forward pass of ByT5 Decoder Auto Regressive/ Text Generation :",
        CALL_DECODER_AUTO_REGRESSIVE_DOCSTRING,
    )
