...
def convert_byt5_pt(model, config, model_name):
    """PT converter
    Args:
    ...
    to_model_vars = [
        "tf_transformers/byt5_encoder/transformer/layer_{}/self_attention/query/kernel:0",
        "tf_transformers/byt5_encoder/transformer/layer_{}/self_attention/key/kernel:0",
        "tf_transformers/byt5_encoder/transformer/layer_{}/self_attention/value/kernel:0",
        "tf_transformers/byt5_encoder/transformer/layer_{}/self_attention_output/kernel:0",
        "tf_transformers/byt5_encoder/transformer/layer_{}/pre_attention_norm/weight:0",
        "tf_transformers/byt5_encoder/transformer/layer_{}/intermediate/kernel:0",
        "tf_transformers/byt5_encoder/transformer/layer_{}/intermediate2/kernel:0",
        "tf_transformers/byt5_encoder/transformer/layer_{}/output/kernel:0",
        "tf_transformers/byt5_encoder/transformer/layer_{}/self_attention_layer_norm/weight:0",
    ]
    ...
    ] = "tf_transformers/byt5_encoder/transformer/layer_0/self_attention/relative_attention_bias/embeddings:0"
    # Word Embedding
    mapping_dict["shared.weight"] = "tf_transformers/byt5_encoder/word_embeddings/embeddings:0"
    # Final Layer Norm weight
    mapping_dict["encoder.final_layer_norm.weight"] = "tf_transformers/byt5_encoder/last_layer_norm/weight:0"
    ...
    to_model_vars = [
        ...
        "tf_transformers/byt5_decoder/transformer/layer_{}/self_attention/key/kernel:0",
        "tf_transformers/byt5_decoder/transformer/layer_{}/self_attention/value/kernel:0",
        "tf_transformers/byt5_decoder/transformer/layer_{}/self_attention_output/kernel:0",
        "tf_transformers/byt5_decoder/transformer/layer_{}/pre_attention_norm/weight:0",
        "tf_transformers/byt5_decoder/transformer/layer_{}/cross_attention/query/kernel:0",
        "tf_transformers/byt5_decoder/transformer/layer_{}/cross_attention/key/kernel:0",
        "tf_transformers/byt5_decoder/transformer/layer_{}/cross_attention/value/kernel:0",
        "tf_transformers/byt5_decoder/transformer/layer_{}/cross_attention_output/kernel:0",
        "tf_transformers/byt5_decoder/transformer/layer_{}/pre_cross_attention_norm/weight:0",
        "tf_transformers/byt5_decoder/transformer/layer_{}/intermediate/kernel:0",
        "tf_transformers/byt5_decoder/transformer/layer_{}/intermediate2/kernel:0",
        "tf_transformers/byt5_decoder/transformer/layer_{}/output/kernel:0",
        "tf_transformers/byt5_decoder/transformer/layer_{}/self_attention_layer_norm/weight:0",
    ]
    ...
    ] = "tf_transformers/byt5_decoder/transformer/layer_0/self_attention/relative_attention_bias/embeddings:0"
    # Final Layer Norm weight
    mapping_dict["decoder.final_layer_norm.weight"] = "tf_transformers/byt5_decoder/last_layer_norm/weight:0"
    ...
    for index, var in enumerate(model.variables):
        ...
        if (
            var.name
            == "tf_transformers/byt5_decoder/transformer/layer_0/cross_attention/relative_attention_bias/embeddings:0"
        ):
    ...
    if SKIP_ASSERT is False:
        ...
        tf.debugging.assert_near(outputs_hf, outputs_tf, rtol=0.5)
...
def convert_t5_tf(model, config, model_name):
    ...
    Returns:
        a function
    """
    raise ValueError("ByT5 TF based conversion from Hf is not available yet. ")
    # When dropout, use_auto_regressive is enabled assertion won't work
    SKIP_ASSERT = False
    try:
        # LegacyLayer
