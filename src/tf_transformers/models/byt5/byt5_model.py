...
code_example = r'''
        ...
        >>> from tf_transformers.models import  ByT5Model
        >>> model = ByT5Model.from_pretrained("byt5-small")
        >>> batch_size = 5
...
class ByT5Model(ModelWrapper):
    r"""ByT5 Encoder Wrapper
    ...
    def update_config(self, tft_config: Dict, hf_config: Dict):
        ...
        # Num decoder layers
        tft_config['num_hidden_layers_decoder'] = hf_config['num_decoder_layers']
        tft_config['intermediate_act'] = 'gelu'
    ...
    def from_config(
        ...
        **kwargs,
        ...
        encoder_layer = Encoder(config=config_dict, name="byt5_encoder", **encoder_kwargs_copy)
        ...
        config_dict_decoder = config_dict.copy()
        if "use_auto_regressive" in decoder_kwargs_copy:
            del decoder_kwargs_copy["use_auto_regressive"]

        if 'num_hidden_layers_decoder' in config_dict:
            config_dict_decoder['num_hidden_layers'] = config_dict['num_hidden_layers_decoder']
        decoder_layer = Encoder(
            config=config_dict_decoder,
            name="byt5_decoder",
            use_decoder=True,
            mask_mode="causal",
    ...
    @classmethod
    @add_start_docstrings(
        "ByT5 Model Pretrained with example :",
        ENCODER_PRETRAINED_DOCSTRING.format(
            "tf_transformers.models.ByT5Model", "tf_transformers.models.ByT5Encoder", "byt5-small", code_example
        ),
    )
    def from_pretrained(
        cls,
