...
class SentenceT5Encoder(LegacyLayer):
    ...
    def call(self, inputs):
        ...
        mean_token_embeddings = self.get_mean_embeddings(token_embeddings, input_mask)  # over sequences
        ...
        if self.return_all_outputs:
            ...
            model_outputs['token_embeddings'] = token_embeddings
            return model_outputs
        else:
            return {
                'sentence_vector': sentence_vector,
                'sentence_vector_normalized': sentence_vector_normalized,
