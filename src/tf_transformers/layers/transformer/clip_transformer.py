...
from tf_transformers.layers.attention import CLIPMultiHeadAttention
from tf_transformers.utils import tf_utils


class TransformerCLIP(LegacyLayer):
    """Transformer
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            is_decoder: bool
        """
        super(TransformerCLIP, self).__init__(name=name, is_training=is_training, use_dropout=use_dropout, **kwargs)
    ...
    def build(self, input_shape):
        ...
        self._attention_layer = CLIPMultiHeadAttention(
        ...
        if self._use_decoder:
            ...
            self._cross_attention_layer = CLIPMultiHeadAttention(
                num_heads=self._num_heads,
                head_size=self._attention_head_size,
                dropout_rate=self._attention_dropout_rate,
        ...
        # )
        super(TransformerCLIP, self).build(input_shape)
    ...
    def get_config(self):
        ...
        base_config = super(TransformerCLIP, self).get_config()
    ...
    def call_encoder(self, inputs, cache_key=None, cache_value=None):
        ...
        attention_output = self._attention_dropout(attention_output + input_tensor, training=self._use_dropout)
        attention_output_copy = tf.identity(attention_output)  # residual
        ...
        return layer_output + attention_output_copy, key, value
